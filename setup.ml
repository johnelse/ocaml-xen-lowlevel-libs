...
(* OASIS_START *)
(* DO NOT EDIT (digest: e17a2a7b3c1c029000ce197870eafcb6) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the xenlight bindings";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the xenctrl bindings";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xenmmap"; "Xenctrl"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xenctrl";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                        ["xentoollog_stubs.c"; "caml_xentoollog.h"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-lxenctrl"; "-lxenguest"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   ...
                   {
                      lib_modules = ["Xentoollog"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xentoollog";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "xenlight";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "xentoollog"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                        ["xenlight_stubs.c"; "caml_xentoollog.h"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
                        [
                           (OASISExpr.EBool true,
                             ["-lxenlight"; "-lxenctrl"; "-lxenguest"])
                        ];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Xenlight"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xenlight";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "test_hvm_check_pvdriver";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_hvm_check_pvdriver.ml"
                   })
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\210L\154\168\176JF\210r\212\165\2023\019\031n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
